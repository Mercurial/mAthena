    ...
    public class TargaImage : IDisposable
    {
        ...
        public System.IO.Stream ImageStream
        {
            get
            {
                ...
                this.bmpTargaImage.Save(s, System.Drawing.Imaging.ImageFormat.Png);
                return s; 
            }
        }
            ...
            : this()
        {
            ...
            {
                // create a seekable memory stream of the file bytes
                using (s = new MemoryStream(data))
                {
                    if (s != null && s.Length > 0 && s.CanSeek == true)
                    {
                        // create a BinaryReader used to read the Targa file
                        using (br = new BinaryReader(s))
                        {
